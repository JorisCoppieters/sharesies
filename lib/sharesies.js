...
function buyFund(user, fund, investAmount) {
    return new Promise((resolve, reject) =>
        request.post(
            'cart/add-item',
            {
...
function confirmInvestment(user) {
    return new Promise((_, reject) => {
        return reject(`NOT IMPLEMENTED: confirmInvestment, FOR USER ID: ${user.id}`);
    });
}
...
module.exports['confirmInvestment'] = confirmInvestment;
